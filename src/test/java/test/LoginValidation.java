...
public class LoginValidation extends Baseclass {
 ...
 /* @Test(priority=8,dependsOnMethods = {"validEmailValidPassword"} )
  ...
  public void validateSearchResults() {
	  String expected="1-48 of 318 results for \"samsung galaxy s10\"";
	  System.out.println(expected);
	  NavigateActions nav = new NavigateActions(driver);
	  String actual=nav.validateSearchResult();
	  assertTrue(expected.equalsIgnoreCase(actual), "this is not a valid displayresult");
